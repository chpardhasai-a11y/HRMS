        ...
        <div className="admin-employee-record-shell">
          <Breadcrumbs
            items={[
              ...
              { label: 'Employee Master', href: '/org-admin#employees' },
              { label: 'Employee Record' }
            ]}
          />
          <div className="admin-employee-record-toolbar">
            <a className="admin-employee-record-link" href="/org-admin">
              <ArrowLeft size={16} />
              Employee Master
            </a>
            <div className="admin-employee-record-actions">
              <a className="admin-employee-record-button" href="/org-admin">
                <History size={16} />
                Audit History
              </a>
